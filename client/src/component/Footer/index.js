...
const Footer = () => {
    return (
        <footer className="footer">
            <p><strong>&copy;2022 Campaign Generator</strong> by <Link className="name" to={{ pathname: "https://erockenmeyer.github.io/Portfolio" }} target="_blank">Erik Rockenmeyer</Link>,
